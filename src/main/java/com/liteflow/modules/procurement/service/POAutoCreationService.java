...
import com.liteflow.modules.procurement.dao.PurchaseOrderItemDAO;
...
public class POAutoCreationService {
    ...
    private final com.liteflow.modules.analytics.service.AIAgentConfigService configService;
    ...
    public POAutoCreationService() {
        ...
        this.configService = new com.liteflow.modules.analytics.service.AIAgentConfigService();
    }
