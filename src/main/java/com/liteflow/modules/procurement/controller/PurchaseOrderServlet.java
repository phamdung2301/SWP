package com.liteflow.modules.procurement.controller;
...
import com.liteflow.modules.procurement.service.ProcurementService;
...
public class PurchaseOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, jakarta.servlet.ServletException {
        ...
        try {
            ...
            List<com.liteflow.modules.procurement.model.Supplier> suppliers = service.getAllSuppliers();
    ...
    private void handleGetDetails(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            // Get supplier name
            com.liteflow.modules.procurement.model.Supplier supplier = service.getSupplierById(po.getSupplierID());
        ...
        if ("approve".equals(action)) {
            try {
                ...
                if (success) {
                    ...
                    try {
                        com.liteflow.modules.core.service.AlertService alertService = new com.liteflow.modules.core.service.AlertService();
