...
import com.liteflow.modules.inventory.model.ProductStock;
import com.liteflow.modules.inventory.model.LowStockItem;
...
public class ProductStockDAO extends GenericDAO<ProductStock, UUID> {
    ...
    public List<LowStockItem> findLowStock(int threshold) {
        ...
        try {
            ...
            String jpql = 
                "SELECT NEW com.liteflow.modules.inventory.model.LowStockItem(" +
                "  p.productId, " +
                "  pv.productVariantId, " +
                "  p.name, " +
                "  pv.size, " +
