...
import com.liteflow.modules.inventory.dao.*;
...
import com.liteflow.modules.core.dao.ReservationDTO;
import com.liteflow.modules.core.dao.PreOrderItemDTO;
...
public class ReceptionServlet extends HttpServlet {
     ...
     */
    private String buildTablesJson(List<com.liteflow.modules.inventory.model.Table> tables) {
        StringBuilder json = new StringBuilder();
        json.append("[");
        for (int i = 0; i < tables.size(); i++) {
            com.liteflow.modules.inventory.model.Table table = tables.get(i);
            json.append("{");
