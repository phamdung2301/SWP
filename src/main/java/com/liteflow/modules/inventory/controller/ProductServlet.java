...
import com.liteflow.modules.inventory.model.ProductDisplayDTO;
import com.liteflow.modules.inventory.service.ProductService;
...
public class ProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("addCategory".equals(action)) {
                ...
                try {
                    com.liteflow.modules.inventory.dao.ProductDAO productDAO = new com.liteflow.modules.inventory.dao.ProductDAO();
                    ...
                    // Create new category
                    com.liteflow.modules.inventory.model.Category category = productDAO.addCategoryIfNotExists(categoryName.trim());
            ...
            if ("create".equals(action)) {
                ...
                com.liteflow.modules.inventory.model.Product newProduct = new com.liteflow.modules.inventory.model.Product();
            ...
            if ("update".equals(action)) {
                ...
                try {
                    ...
                    com.liteflow.modules.inventory.dao.ProductDAO productDAO = new com.liteflow.modules.inventory.dao.ProductDAO();
                    com.liteflow.modules.inventory.model.Product product = productDAO.findById(productId);
                    if (product == null) {
                ...
                try {
                    ...
                    try {
                        ...
                        var variant = em.createQuery(
                            ...
                            com.liteflow.modules.inventory.model.ProductVariant.class
            ...
            try (java.io.InputStream inputStream = filePart.getInputStream()) {
                ...
                for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                    ...
                    try {
                        ...
                        com.liteflow.modules.inventory.model.Product product = new com.liteflow.modules.inventory.model.Product();
    ...
    private void createProductVariantAndStock(com.liteflow.modules.inventory.model.Product product, String size, double price, int stock) {
        try {
            // Tạo ProductVariant
            com.liteflow.modules.inventory.model.ProductVariant variant = new com.liteflow.modules.inventory.model.ProductVariant();
    ...
    private com.liteflow.modules.inventory.model.Inventory getOrCreateDefaultInventory() {
        try {
            ...
            com.liteflow.modules.inventory.model.Inventory defaultInventory = inventoryDAO.findByField("storeLocation", "Kho chính");
            
            if (defaultInventory == null) {
                // Tạo inventory mặc định nếu chưa có
                defaultInventory = new com.liteflow.modules.inventory.model.Inventory();
    ...
    private void createProductCategory(com.liteflow.modules.inventory.model.Product product, String categoryName) {
        try {
            // Tìm hoặc tạo category
            com.liteflow.modules.inventory.dao.ProductDAO productDAO = new com.liteflow.modules.inventory.dao.ProductDAO();
            com.liteflow.modules.inventory.model.Category category = productDAO.addCategoryIfNotExists(categoryName);
            ...
            // Tạo ProductCategory
            com.liteflow.modules.inventory.model.ProductCategory productCategory = new com.liteflow.modules.inventory.model.ProductCategory();
    ...
    private void linkProductToCategory(com.liteflow.modules.inventory.model.Product product, String categoryName) {
        try {
            com.liteflow.modules.inventory.dao.ProductDAO productDAO = new com.liteflow.modules.inventory.dao.ProductDAO();
    ...
    private void deleteCategory(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            com.liteflow.modules.inventory.dao.ProductDAO productDAO = new com.liteflow.modules.inventory.dao.ProductDAO();
            com.liteflow.modules.inventory.model.Category category = productDAO.findCategoryByName(categoryName.trim());
