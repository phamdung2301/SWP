...
import com.liteflow.modules.inventory.dao.RoomDAO;
import com.liteflow.modules.inventory.dao.TableDAO;
...
public class RoomTableService {
    ...
    public RoomTableService() {
        ...
        this.emf = com.liteflow.modules.core.dao.BaseDAO.emf;
    }
    ...
    public com.liteflow.modules.inventory.model.TableSession getActiveSessionByTableId(UUID tableId) {
        EntityManager em = this.emf.createEntityManager();
        try {
            ...
            q.setMaxResults(1);
            return (com.liteflow.modules.inventory.model.TableSession) q.getSingleResult();
    ...
    public java.util.List<com.liteflow.modules.inventory.model.TableSession> getTableSessions(UUID tableId) {
        return getTableSessionsByTableId(tableId);
    }
    
    // Method to get completed table sessions (invoices) - similar to cashier notification
    
    public java.util.List<com.liteflow.modules.inventory.model.TableSession> getCompletedTableSessions(UUID tableId) {
        EntityManager em = this.emf.createEntityManager();
        try {
    ...
    public java.util.List<com.liteflow.modules.inventory.model.PaymentTransaction> getTablePayments(UUID tableId) {
        EntityManager em = this.emf.createEntityManager();
        try {
    ...
    public java.util.List<com.liteflow.modules.inventory.model.OrderDetail> getOrderDetailsForSession(UUID sessionId) {
        EntityManager em = this.emf.createEntityManager();
        try {
    ...
    public java.util.List<com.liteflow.modules.inventory.model.Order> getSessionOrders(UUID sessionId) {
        EntityManager em = this.emf.createEntityManager();
        try {
            jakarta.persistence.Query q = em.createQuery(
    ...
    public java.util.List<com.liteflow.modules.inventory.model.OrderDetail> getOrderDetails(UUID orderId) {
        EntityManager em = this.emf.createEntityManager();
        try {
            jakarta.persistence.Query q = em.createQuery(
    ...
    public java.util.List<com.liteflow.modules.inventory.model.TableSession> getTableSessionsByTableId(UUID tableId) {
        EntityManager em = this.emf.createEntityManager();
        try {
            jakarta.persistence.Query q = em.createQuery(
                "SELECT ts FROM TableSession ts " +
    ...
    public long getCompletedOrdersToday() {
        ...
        try {
            ...
            TypedQuery<Long> query = em.createQuery(
                "SELECT COUNT(o) FROM com.liteflow.modules.inventory.model.Order o " +
