...
public class AIAgentConfigAPIServlet extends HttpServlet {
    ...
    private void handleGetSuppliers(HttpServletResponse response) throws IOException {
        try {
            com.liteflow.modules.procurement.service.ProcurementService procurementService = 
                new com.liteflow.modules.procurement.service.ProcurementService();
            java.util.List<com.liteflow.modules.procurement.model.Supplier> suppliers = 
                procurementService.getAllSuppliers();
            
            org.json.JSONArray suppliersArray = new org.json.JSONArray();
            for (com.liteflow.modules.procurement.model.Supplier supplier : suppliers) {
    ...
    private void handleGetCategories(HttpServletResponse response) throws IOException {
        try {
            com.liteflow.modules.inventory.service.ProductService productService = 
                new com.liteflow.modules.inventory.service.ProductService();
    ...
    private void handleGetProducts(HttpServletResponse response, String categoryName) throws IOException {
        try {
            ...
            com.liteflow.modules.inventory.service.ProductInventoryService productInventoryService = 
                new com.liteflow.modules.inventory.service.ProductInventoryService();
