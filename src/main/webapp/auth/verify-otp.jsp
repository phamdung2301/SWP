...
<html>
    <head>
    <title>LiteFlow - Verify OTP</title>
    ...
    <body>
        ...
        <script>
            // Auto-advance & digit-only handling for OTP inputs (align with new pages)
            ...
            const RESEND_KEY = 'liteflow_resend_until_login';
            ...
            if (resendLink) {
                resendLink.addEventListener('click', function(e) {
                    ...
                    // UI feedback & immediate cooldown
                    resendLink.style.opacity = '0.5';
            ...
            // Start cooldown if redirected with sent=1 and no cooldown exists yet
            ...
            // Require 6 digits before submit, show inline error
